    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anim_gender', models.IntegerField(choices=[(1, 'Самка'), (0, 'Самец')], default=1, verbose_name='Пол животного')),
                ('anim_image_to_show', models.TextField(help_text='Вставьте сюда ID изображения животного в Telegram или ссылку на изображение.', verbose_name='Изображение для Telegram')),
                ('anim_image_to_send', models.TextField(help_text='Вставьте сюда ID изображения животного в Telegram или ссылку на изображение.', verbose_name='Изображение для отправки/репоста')),
