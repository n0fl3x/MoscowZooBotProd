from commands.admin_commands import STOP_ADMIN_COMMAND, HELP_ADMIN_COMMAND


HELLO_ADMIN = f"""
Вы являетесь администратором этого бота и имеете доступ к его скрытому функционалу!
Если Вам нужна помощь, нажмите кнопку <b><i>{HELP_ADMIN_COMMAND}</i></b> 👇🏻
"""
...
Для того, чтобы выйти из панели администратора, нажмите кнопку '{STOP_ADMIN_COMMAND}'
"""
